      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center py-6">
          ...
          <nav className="hidden md:flex space-x-10">
            ...
            <Link href="/projects" className="text-base font-medium text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white">
              Projects
            </Link>
            <Link href="#portfolio" className="text-base font-medium text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white">
              Portfolio
            </Link>
            <Link href="#skills" className="text-base font-medium text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white">
              Skills
            </Link>
            <Link href="#services" className="text-base font-medium text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white">
              Services
            </Link>
